...
THREE.MD2CharacterComplexWulf = function () {
	...
	this.loadParts = function ( config ) {
		...
		// this.skinsBody = loadTextures( "skins/", config.skins );
		// this.skinsWeapon = loadTextures( "skins/", weaponsTextures );
	...
	this.updateBehaviors = function ( delta ) {
		...
		if ( controls.attack ) {
			...
			if ( controls.crouch ) {
				...
				moveAnimation = animations[ "crouchMove" ];
				idleAnimation = animations[ "crouchMove" ];
